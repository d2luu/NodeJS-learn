...
program.version('1.0.0').usage('[options] <file ...>').option('-d, --date <date>', 'Show calendar for specific date (ddMMyyyy|MMyyyy|yyyy)', parseDate).option('-y, --year', 'Show year calendar').parse(process.argv);
